...
public class FireBallTest {
    ...
    @Test
    public void given50_whenRollMethodCalled_displayRollingMessage() {
        FireBall fireBall = new FireBall(50);
        fireBall.roll();
        assertEquals("FireBall is rolled with " + 50 + " kmh speed!", outputStream.toString().trim());
    }
